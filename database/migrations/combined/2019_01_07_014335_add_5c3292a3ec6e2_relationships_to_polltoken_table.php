...
class Add5c3292a3ec6e2RelationshipsToPolltokenTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function down()
    {
        Schema::table('polltokens', function(Blueprint $table) {
            if(Schema::hasColumn('polltokens', 'user_id')) {
                $table->dropForeign('249764_5c3292a16612c');
                $table->dropIndex('249764_5c3292a16612c');
                $table->dropColumn('user_id');
            }
            if(Schema::hasColumn('polltokens', 'poll_id')) {
                $table->dropForeign('249764_5c3292a17a270');
                $table->dropIndex('249764_5c3292a17a270');
