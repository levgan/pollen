...
@section('content')
    ...
    {!! Form::model($poll, ['method' => 'PUT', 'route' => ['admin.polls.update', $poll->id]]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('question[]', $questions, old('question') ? old('question') : $poll->question->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-question' ]) !!}
                    <p class="help-block"></p>
